...
@override
int get hashCode => Object.hash(runtimeType,temperature,feelsLike,humidity,pressure,visibility,windSpeed,windDeg,description,iconCode,cityName,countryCode,sunrise,sunset);

@override
String toString() {
  return 'WeatherModel(temperature: $temperature, feelsLike: $feelsLike, humidity: $humidity, pressure: $pressure, visibility: $visibility, windSpeed: $windSpeed, windDeg: $windDeg, description: $description, iconCode: $iconCode, cityName: $cityName, countryCode: $countryCode, sunrise: $sunrise, sunset: $sunset)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'temp')  double temperature, @JsonKey(name: 'feels_like')  double feelsLike, @JsonKey(name: 'humidity')  int humidity, @JsonKey(name: 'pressure')  int pressure, @JsonKey(name: 'visibility')  int? visibility, @JsonKey(name: 'wind_speed')  double windSpeed, @JsonKey(name: 'wind_deg')  int? windDeg, @JsonKey(name: 'description')  String description, @JsonKey(name: 'icon_code')  String iconCode, @JsonKey(name: 'city_name')  String cityName, @JsonKey(name: 'country_code')  String countryCode, @JsonKey(name: 'sunrise')  DateTime sunrise, @JsonKey(name: 'sunset')  DateTime sunset)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeatherModel() when $default != null:
return $default(_that.temperature,_that.feelsLike,_that.humidity,_that.pressure,_that.visibility,_that.windSpeed,_that.windDeg,_that.description,_that.iconCode,_that.cityName,_that.countryCode,_that.sunrise,_that.sunset);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'temp')  double temperature, @JsonKey(name: 'feels_like')  double feelsLike, @JsonKey(name: 'humidity')  int humidity, @JsonKey(name: 'pressure')  int pressure, @JsonKey(name: 'visibility')  int? visibility, @JsonKey(name: 'wind_speed')  double windSpeed, @JsonKey(name: 'wind_deg')  int? windDeg, @JsonKey(name: 'description')  String description, @JsonKey(name: 'icon_code')  String iconCode, @JsonKey(name: 'city_name')  String cityName, @JsonKey(name: 'country_code')  String countryCode, @JsonKey(name: 'sunrise')  DateTime sunrise, @JsonKey(name: 'sunset')  DateTime sunset)  $default,) {final _that = this;
switch (_that) {
case _WeatherModel():
return $default(_that.temperature,_that.feelsLike,_that.humidity,_that.pressure,_that.visibility,_that.windSpeed,_that.windDeg,_that.description,_that.iconCode,_that.cityName,_that.countryCode,_that.sunrise,_that.sunset);case _:
  throw StateError('Unexpected subclass');
